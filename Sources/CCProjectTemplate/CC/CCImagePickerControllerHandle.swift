//
//  CCImagePickerControllerHandle.swift
...
/**
 CC图片/视频选择控制器处理
 */
open class CCImagePickerControllerHandle: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    
    /// 完成图片/视频选择
    open var finishPickingMediaWithInfoBlock: (UIImage?, URL?)->Void = {_,_ in}
    /// 取消图片/视频选择
